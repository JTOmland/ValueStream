...
function SimulationService(DataFactory) {
    var service = {
        ...
        random: gaussianRand
       // buildScheduleStack: buildScheduleStack
    };
    ...
    function runSimulation(inventory) {
        ...
        buildScheduleStack();
        console.log("schedulestack ",scheduleStack)
    ...
    function buildScheduleStack() {
        console.log("Datafactory in buildScheduleStack", DataFactory.workCenterModel());
        
        //todo could consider adding a check for priority before putting a wc process on stack.
        _.each(DataFactory.workCenterModel(), function (workcenter) {
            console.log("workcenter is busy", workcenter, workcenter.isBusy)
